...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    // Simulate API call
    setTimeout(() => {
      // Success simulation - in production replace with actual EmailJS call
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="mt-4 space-y-3 text-gray-600">
                  <p className="flex items-start">
                    ...
                    <span>123 Iran Street, Tehran, Iran</span>
                  </p>
                  <p className="flex items-start">
                    <svg className="w-5 h-5 mr-3 text-purple-500 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="flex items-start">
                    ...
                    <span>iran@crystarasugar.com</span>
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="mt-4 space-y-3 text-gray-600">
                  <p className="flex items-start">
                    <svg className="w-5 h-5 mr-3 text-indigo-500 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                    </svg>
                    <span>456 Turkey Avenue, Istanbul, Turkey</span>
                  </p>
                  <p className="flex items-start">
                    <svg className="w-5 h-5 mr-3 text-indigo-500 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                  ...
                  <p className="flex items-start">
                    ...
                    <span>turkey@crystarasugar.com</span>
                  </p>
                </div>
              </motion.div>
            </motion.div>

            {/* Map Section - UPDATED with the provided link */}
            <motion.div 
              className="mt-10"
              variants={itemVariants}
            >
              ...
              <div className="rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d808.7270969280654!2d51.46118146899642!3d35.78076888627757!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3f8e061c6e0f1b99%3A0x4f1b6ceeddaa4c4!2sShian%20Co.!5e0!3m2!1sen!2s!4v1712415647798!5m2!1sen!2s"
                  width="100%"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen=""
